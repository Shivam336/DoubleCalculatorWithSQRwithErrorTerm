 ...
 * 
 * 
 * @version 4.00	2018-02-27	 Double Calculator 
 * 
 */
...
public class TestCalculatorValue {
	...
	public static void main(String[] args) {
		...
		right.sub(left);														// Perform the test
		...
		// 9. Perform Squareroot
		left = new CalculatorValue("1");										// Set up the test
		right = new CalculatorValue("2");
		
		right.sqrt(left);														// Perform the test
		
		System.out.println("5. Squareroot Input: \n2\n1");	
